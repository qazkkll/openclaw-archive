...
MODEL_PATH = os.path.join(ROOT, "models/us/blueshield_v10_lambdamart.txt")
...
def main():
    ...
    out = {
        ...
        "model": "blueshield_v10_lambdamart",
        "version": "V10-LambdaMART",
        "universe": ">$10",
        "total": len(latest),
        "picks": picks,
        "vix": vix_close,
    }
    out_path = os.path.join(OUTPUT_DIR, f"blueshield_v10_scored_{latest_date.strftime('%Y%m%d')}.json")
